...
const AddContractorScreen = ({ navigation, route }) => {
            ...
            <VStack flex={1} backgroundColor={"#000000"}>
                ...
                <ScrollView backgroundColor={lightColor} borderTopLeftRadius={12} borderTopRightRadius={12} width={'94%'} alignSelf="center" ref={scrollRef} automaticallyAdjustKeyboardInsets={true}>
                    <VStack space={5} padding={8}>
                        <Text color={darkColor} fontFamily={fontBold} fontSize="lg">{t("Please add your contractor")}</Text>
                        ...
                        {currentStep == 3 && (
                            <Stack space={5}>
                                <Text color={baseColor} fontSize="xs" fontWeight="normal"><Text fontWeight="bold">{t("Note :")}</Text>{t("All auto-filled data fetched form as per Aadhaar/PAN")}</Text>
