  ...
  var PurchaseHistoryScreen = function PurchaseHistoryScreen(_ref) {
    ...
    var _React$useState3 = _react.default.useState([]),
      ...
      purchaseList = _React$useState4[0],
      setPurchaseList = _React$useState4[1];
    ...
    var _React$useState17 = _react.default.useState(false),
      ...
      dateFilter = _React$useState18[0],
      setDateFilter = _React$useState18[1];
    var _React$useState19 = _react.default.useState(""),
      _React$useState20 = (0, _slicedToArray2.default)(_React$useState19, 2),
      fromDate = _React$useState20[0],
      setFromDate = _React$useState20[1];
    var _React$useState21 = _react.default.useState(""),
      _React$useState22 = (0, _slicedToArray2.default)(_React$useState21, 2),
      toDate = _React$useState22[0],
      setToDate = _React$useState22[1];
    var _React$useState23 = _react.default.useState(""),
      _React$useState24 = (0, _slicedToArray2.default)(_React$useState23, 2),
      dateType = _React$useState24[0],
      setDateType = _React$useState24[1];
    var today = new Date();
    ...
    var getAllData = function getAllData(filterValue, startDate, endDate) {
      _asyncStorage.default.getItem('userToken').then(function (val) {
        if (val != null) {
          ...
          formdata.append("fromDate", startDate == "" ? "" : (0, _moment.default)(startDate).format("DD-MM-YYYY"));
          formdata.append("tillDate", endDate == "" ? "" : (0, _moment.default)(endDate).format("DD-MM-YYYY"));
          formdata.append("status", filterValue);
          fetch(`${_Config.BASE_URL}/my-purchases`, {
            method: 'POST',
            headers: {
    ...
    var loadMore = function loadMore() {
      ...
      _asyncStorage.default.getItem('userToken').then(function (val) {
        if (val != null) {
          ...
          formdata.append("search_value", searchTerms);
          formdata.append("fromDate", fromDate == "" ? "" : (0, _moment.default)(fromDate).format("DD-MM-YYYY"));
          formdata.append("tillDate", toDate == "" ? "" : (0, _moment.default)(toDate).format("DD-MM-YYYY"));
          ...
          fetch(`${_Config.BASE_URL}/my-purchases`, {
            ...
            if (responseJson.bstatus == 1) {
              ...
              setTotalPage(responseJson.total_pages);
              setPageNumber(num);
              var newArrya = purchaseList.concat(responseJson.sale_details);
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
              ...
              children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Input, {
                ...
                placeholder: t("Trans ID / Product"),
            ...
            }), purchaseList.length == 0 && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
              space: 6,
              backgroundColor: _MainStyle.lightColor,
              borderRadius: 8,
              overflow: "hidden",
                  ...
                  children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
                    ...
                    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
                      ...
                      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                        ...
                        fontSize: "xs",
                        fontFamily: _MainStyle.fontRegular,
                        children: t(item.approveStatus == "Pending" ? "Pending With" : item.approveStatus == "Rejected" ? "Rejected By" : "Approved By")
                      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                        width: '58%',
                        color: _MainStyle.darkColor,
                        fontSize: "xs",
            ...
            }), purchaseList.length != 0 && pageNumber != totalPage && /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.HStack, {
              paddingY: "3",
              paddingX: "6",
              justifyContent: "center",
              children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Button, {
  ...
  var _default = exports.default = PurchaseHistoryScreen;
