  ...
  var AddPurchaseScreen = function AddPurchaseScreen(_ref) {
    ...
    var _React$useState47 = _react.default.useState(""),
      ...
      purchaseMaxData = _React$useState48[0],
      setPurchaseMaxData = _React$useState48[1];
    var _React$useState49 = _react.default.useState(""),
      _React$useState50 = (0, _slicedToArray2.default)(_React$useState49, 2),
      miniData = _React$useState50[0],
      setMiniData = _React$useState50[1];
    ...
    var onSubmit = function onSubmit() {
      if (purchaseDate == "") {
        _reactNativeSimpleToast.default.show(t("Please select Purchase Date"), _reactNativeSimpleToast.default.LONG);
        setStep1(true);
      } else if (!dealerFound) {
        ...
        setStep2(true);
        if (customerName == "") {
          _reactNativeSimpleToast.default.show(t("Please enter Customer Name"), _reactNativeSimpleToast.default.LONG);
        } else if (customerName != "" && regexAlpha.test(customerName)) {
          _reactNativeSimpleToast.default.show(t("Please enter Only Alphabet"), _reactNativeSimpleToast.default.LONG);
          ...
          _reactNativeSimpleToast.default.show(t("Cunstomer Phone Number accept Only Number / Mobile No. not Valid"), _reactNativeSimpleToast.default.LONG);
        } else {
          setStep2(false);
          setStep3(true);
          if (purchaseArrya.length == 0) {
            setActionPOP(true);
            _reactNativeSimpleToast.default.show(t("Please Add some Purchase"), _reactNativeSimpleToast.default.LONG);
          } else {
            setLoading(true);
            setDissable(true);
            _asyncStorage.default.getItem('userToken').then(function (val) {
    ...
    var addPurchase = function addPurchase(saleToken) {
      _asyncStorage.default.getItem('userToken').then(function (val) {
        if (val != null) {
          ...
          fetch(`${_Config.BASE_URL}/purchase-registration`, {
            method: 'POST',
            headers: {
              'Content-Type': 'multipart/form-data',
              'accesstoken': `${_Config.AccessToken}`,
    ...
    var addPurchaseDetails = function addPurchaseDetails() {
      if (productId == "") {
        ...
        var newArrya = purchaseArrya.concat({
          "productName": productName,
          "saleQuantity": totalBag,
          "productId": productId
        });
    ...
    var rmFromArrya = function rmFromArrya(indexVal) {
      _reactNative.Alert.alert(t("Warning !"), t("Do you want to remove this purchase") + "?", [{
        text: t("Cancel"),
        ...
        text: t("Yes"),
        onPress: function onPress() {
          var reducedArr = purchaseArrya.filter(function (item, itemIndex) {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Header.default, {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Stack, {
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.Pressable, {
              ...
              }), step1 && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
                space: 2,
                backgroundColor: _MainStyle.baseLightColor,
                borderRadius: 6,
                overflow: "hidden",
                ...
                children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
                  children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                    ...
                    fontSize: "xs",
                    children: [t("Purchase Date"), " ", /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.Pressable, {
              ...
              }), step2 && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
                space: 2,
                backgroundColor: _MainStyle.baseLightColor,
                borderRadius: 6,
                overflow: "hidden",
                ...
                children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
                  children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                    style: _MainStyle.MainStyle.lable,
                    fontSize: "xs",
                    children: [t("Customer Name"), " ", /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                      color: _MainStyle.dangerColor,
                      children: "*"
                    })]
                  }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.Pressable, {
                ...
                children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
                  ...
                  children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                    ...
                    fontFamily: _MainStyle.fontBold,
                    marginLeft: 12,
                    children: t("Add Purchase Details")
                  }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Pressable, {
                    style: [_MainStyle.MainStyle.solidbtn, {
                      backgroundColor: _MainStyle.baseColor,
                      height: 36,
              ...
              }), step3 && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
                space: 2,
                backgroundColor: _MainStyle.baseLightColor,
                borderRadius: 6,
                overflow: "hidden",
                ...
                children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.VStack, {
                  space: 2,
                  children: purchaseArrya.map(function (item, index) {
                    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
                      ...
                      children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Stack, {
                        ...
                        children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
                          ...
                          children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                            fontFamily: _MainStyle.fontRegular,
                            children: [t("Total Bag"), ":"]
                          }), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                            fontFamily: _MainStyle.fontBold,
                            color: _MainStyle.baseColor,
                            children: [item.saleQuantity, " ", "Bag(s)"]
                          })]
                        })]
                      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Pressable, {
                        onPress: function onPress() {
                          return rmFromArrya(index);
                        },
                        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Ionicons.default, {
                ...
                }), purchaseArrya.length == 0 && /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Button, {
                  variant: "outline",
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
                        ...
                        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
                          ...
                          children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
                            ...
                            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Image, {
                              source: item.product_image == "" ? _$$_REQUIRE(_dependencyMap[17]) : {
                            ...
                            paddingRight: 2,
                            children: item.product_is_premium == true && /*#__PURE__*/(0, _jsxRuntime.jsx)(_Ionicons.default, {
                              name: "star",
                              size: 22,
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                style: _MainStyle.MainStyle.lable,
                fontSize: "xs",
                children: [t("Total Bags"), " ", /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                  color: _MainStyle.dangerColor,
                  children: "*"
                })]
              }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Image, {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
              ...
              fontFamily: _MainStyle.fontSemiBold,
              textAlign: "center",
              children: [t("Purchase has been sent to your"), " ", /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                fontSize: "sm",
                fontFamily: _MainStyle.fontBold,
                children: [officerType, " ", officerName]
              })]
            }), (officerPhone == null ? undefined : officerPhone.trim()) !== "" && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.HStack, {
              space: 2,
              justifyContent: "center",
              alignItems: "center",
              children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
  ...
  var _default = exports.default = AddPurchaseScreen;
