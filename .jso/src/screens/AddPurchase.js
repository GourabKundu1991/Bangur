  ...
  var AddPurchaseScreen = function AddPurchaseScreen(_ref) {
    ...
    var _React$useState45 = _react.default.useState(""),
      ...
      purchaseMaxData = _React$useState46[0],
      setPurchaseMaxData = _React$useState46[1];
    var _React$useState47 = _react.default.useState(""),
      _React$useState48 = (0, _slicedToArray2.default)(_React$useState47, 2),
      miniData = _React$useState48[0],
      setMiniData = _React$useState48[1];
