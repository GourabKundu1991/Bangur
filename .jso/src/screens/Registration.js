  ...
  var RegistrationScreen = function RegistrationScreen(_ref) {
    ...
    var searchReferral = function searchReferral() {
      if (referrPhone.trim() == "") {
        _reactNativeSimpleToast.default.show(t("Please enter Referred Phone Number"), _reactNativeSimpleToast.default.LONG);
      } else if (referrPhone.length < 10) {
        _reactNativeSimpleToast.default.show(t("Please enter 10 digit for Phone Number"), _reactNativeSimpleToast.default.LONG);
      } else if (referrPhone != "" && !regexNum.test(referrPhone)) {
        _reactNativeSimpleToast.default.show(t("Referred Phone Number accept Only Number / Mobile No. not Valid"), _reactNativeSimpleToast.default.LONG);
      } else {
        setLoading(true);
        var formdata = new FormData();
        formdata.append("phoneNumber", referrPhone);
        formdata.append("lang_code", currentLanguage);
        fetch(`${_Config.BASE_URL}/registration/get-referrer`, {
          method: 'POST',
          headers: {
            'Content-Type': 'multipart/form-data',
            'accesstoken': `${_Config.AccessToken}`
    ...
    var editReferr = function editReferr() {
      setReferrFound(false);
      setReferrPhone("");
      setReferrBy("");
    };
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_Header.default, {
          ...
          children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
              ...
              fontSize: "lg",
              children: t("Please create your account")
              ...
              children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
                ...
                children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                  ...
                  children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                    fontWeight: "bold",
                    children: t("Note :")
                  }), " ", t("Please enter Contractor / Mason contact number who referred this program to you")]
                }), /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Stack, {
                  space: 2,
                  marginTop: 3,
                  children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
                    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                      style: _MainStyle.MainStyle.lable,
                      fontSize: "xs",
                      children: t("Referred By (Mobile No.)")
                    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
                      style: _MainStyle.MainStyle.inputbox,
                      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Input, {
                        value: referrPhone,
                        readOnly: referrFound,
                        backgroundColor: referrFound ? _MainStyle.lightGrey : _MainStyle.lightColor,
                        fontFamily: _MainStyle.fontRegular,
                        size: "md",
                        variant: "unstyled",
                        onChangeText: function onChangeText(text) {
                          return setReferrPhone(text);
                        },
                        placeholder: t("Please Enter Mobile No."),
                        keyboardType: "number-pad",
                        maxLength: 10,
                        InputRightElement: referrFound ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Button, {
                          size: "xs",
                          style: [_MainStyle.MainStyle.solidbtn, {
                            backgroundColor: _MainStyle.darkColor,
                            height: 37,
                  ...
                  }), referrBy != "" && /*#__PURE__*/(0, _jsxRuntime.jsxs)(_reactNative.View, {
                    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
                      style: _MainStyle.MainStyle.lable,
                      fontSize: "xs",
                      children: t("Contractor Name")
                    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.View, {
                      style: _MainStyle.MainStyle.inputbox,
                      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Input, {
                        backgroundColor: _MainStyle.lightGrey,
                        value: referrBy.name + " -- (" + referrBy.externalId + ")",
                        fontFamily: _MainStyle.fontRegular,
                        size: "md",
                        variant: "unstyled",
                        readOnly: true
              ...
              justifyContent: "space-between",
              alignItems: "center",
              children: [currentStep != 1 && /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Button, {
                ...
                style: [_MainStyle.MainStyle.solidbtn, currentStep != 1 ? styles.halfbtn : styles.fullbtn],
                onPress: function onPress() {
                  return onNext();
                },
                children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.VStack, {
          ...
          children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_reactNative.Image, {
            ...
            children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_nativeBase.Text, {
              ...
              fontFamily: _MainStyle.fontSemiBold,
              textAlign: "center",
              children: [t("Your request has been sent for approval to your mapped"), " ", /*#__PURE__*/(0, _jsxRuntime.jsxs)(_nativeBase.Text, {
                fontSize: "sm",
                fontFamily: _MainStyle.fontBold,
  ...
  var _default = exports.default = RegistrationScreen;
